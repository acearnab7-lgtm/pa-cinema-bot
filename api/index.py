...
# This pulls your API key from Vercel's 'Environment Variables'
...
TRUSTED_STUDIOS = ["Marvel", "Warner Bros", "DC", "Rockstar", "Sony Pictures", "Paramount", "Universal", "Netflix", "Prime Video", "Zee Cinema", "T-Series", "YRF", "Disney"]
...
def handle_vault(call):
    ...
    q_map = {"hindi": "hindi+trailer", "english": "hollywood+trailer", "ghost": "horror+trailer", "comedy": "comedy+trailer", "action": "action+trailer", "top": "trending+trailer"}
